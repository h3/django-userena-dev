...
# Django settings for gestionvalrive project.
...
SECRET_KEY = '1+h)sd55s3z0#h$gcq2ad$c)jt#a2k9l)wupksp)rmo9l7-+rb'
...
ROOT_URLCONF = 'userena_dev.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'userena_dev.wsgi.application'
